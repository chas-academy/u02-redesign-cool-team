...
function changeItemInfo(item) {
  ...
  switch (item) {
    case 'yh':
      itemContent.textContent = 'Utbildningar som svarar mot arbetslivets behov av kvalificerad yrkeskompetens och som drivs i nära samverkan med företag och andra arbetsgivare.';
      break;
    case 'kk':
      itemContent.textContent = 'Utbildningar som är högskoleförberedande, yrkesinriktade eller inom kulturarvsområdet och drivs av privata utbildningsanordnare.';
      break;
    case 'tu':
      itemContent.textContent = 'Utbildningar till kontakttolk, teckenspråks- och dövblindtolk samt skrivtolk som drivs av folkhögskolor och studieförbund.';
      break;
    case 'umt':
      itemContent.textContent = 'Eftergymnasiala utbildningar inom olika områden som bedrivs av fristående skolor. Utbildningarnas statliga stöd omfattas endast av tillsyn.';
      break;
    case 'seqf':
      itemContent.textContent = 'Sveriges referensram för kvalifikationer (SeQF) ska synliggöra allt lärande för att öka matchningen på arbetsmarknaden.';
      break;
    case 'vd':
